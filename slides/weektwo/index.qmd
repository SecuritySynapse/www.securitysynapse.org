...
def obfuscate_file(file_path: str, key: str):
    """Obfuscate a file using a symmetric key."""
    ...
    hash_object.update((data_string + key).encode())
    # get the hexadecimal representation of the hash
    hash_hex = hash_object.hexdigest()
    # encode the hash in Base64 for obfuscation
    obfuscated_data = base64.b64encode(hash_hex.encode())
    # return the obfuscated data
    return obfuscated_data

# define a symmetric key (must be kept secret)
key = "f3d1d0c4-9b7f-4f5f-8f2b-3b1d1f2b1d1f"
# obfuscate and display the file
obfuscated_data = obfuscate_file('security.json', key)
# save the obfuscated data to a file
with open('security-obfuscated.json', 'w') as file:
  file.write(obfuscated_data.decode())
