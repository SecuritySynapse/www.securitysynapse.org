...
def top_k_frequent_words(frequency, k):
    return frequency.most_common(k)

def bottom_k_frequent_words(frequency, k):
...
```{python}
text = "This is a sample text. This text is for testing the frequency analysis. Frequency analysis is useful."
...
print(f"Top-{top_k} Most Frequent Words: {top_k_words}")

# Get bottom-3 least frequent words
bottom_k = 3
bottom_k_words = bottom_k_frequent_words(frequency, bottom_k)
print(f"Bottom-{bottom_k} Least Frequent Words: {bottom_k_words}")
```
