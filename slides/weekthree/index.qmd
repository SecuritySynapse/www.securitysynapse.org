...
- Hash with `compute_hash`
- Fixed-length SHA-256 digest
- Detect any change or tampering
...
- **Chapter 1 connection**: use **CIA** and **AAA** to ask who can act, what
can happen, how we will know, and how we keep data secret! Any questions?
