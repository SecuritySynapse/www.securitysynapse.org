...
::: {.callout-note icon=false title="Evaluation of a Biometric-based System"}
...
::: {.incremental .fade style="margin-top: -0.45em; font-size: 0.8em;"}
...
::: {.incremental .fade style="margin-top: 1.15em; font-size: 0.8em;"}
