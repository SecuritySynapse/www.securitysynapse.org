...
- **Module One**: Week One through Week Six
  - **Week One**: Textbook overview for both
  ...
  - **Week Four**: Chapters four through twelve in [CCP](https://inventwithpython.com/cracking/)
  - **Week Five**: Chapter three in [CSP](https://web.njit.edu/~rt494/security/)
  - **Week Six**: Review all prior chapters in [CSP](https://web.njit.edu/~rt494/security/) and [CCP](https://inventwithpython.com/cracking/)
