...
instructor, all students should use their computer to take these
knowledge-checks on the scheduled date and to complete it in the stated location
while taking no more than the required amount of time. Designed to prepare
learners for the discussion of computer security concepts during an in-person
assessment, each security-check involves the completion of an automatically
scored online, form-based assessment and a brief, in-person assessment completed
interactively with the course instructor. Unless the instructor provides access
to a computational device, the brief in-person assessments invite students to
demonstrate their knowledge of computer security without the aid of any external
sources, including, but not limited to, software tools running on a student
laptop. With that said, students may use external sources, including artificial
coding assistants, during the completion of the form-based component of the
knowledge-check.
...
computer to take these examinations on the scheduled date and to complete it in
the stated location while taking no more than the required amount of time. Each
...
Classroom (i.e., cs50), and/or the [Security Synapse Discord
Server](https://discord.gg/juUXz7d4Jh). No credit will be awarded for any
course work that you submit to the incorrect GitHub repository or web site.
Unless special advance arrangements are made with the instructor to address
extenuating circumstances or a student pays a token for their project, no late
...
privately receive a grade for and/or feedback on your course projects and all
types of course assessments. Your grade will be a function of whether or not
you (a) completed work that fulfills the specification for the project or
assessment and (b) submitted it by the deadline to the stated platform.
...
of the security summit project, or either of the midterm examinations. Students
...
technical development, and project development in the field of computer
security. Although the course instructor will always be available to serve as
mentor for individual students, teams of students, and the entire class, it is
...
applying the assigned material will be able to effectively participate in these
...
this course are encouraged to seek assistance from the course instructor.
Students should, within the bounds of the Honor Code, ask and answer questions
on the [Security Synapse Discord Server](https://discord.gg/juUXz7d4Jh);
please request assistance from the instructor first through public Discord
channels before sending an email or a direct message. Students who need more
assistance are invited to schedule a meeting through the [instructor's
appointment scheduler](https://www.gregorykapfhammer.com/schedule/) and come to
the meeting with details about their question. Students can see the office hour
schedule for student technical leaders by viewing the list of [student
technical leaders](https://www.cis.allegheny.edu/teaching/technicalleaders/)
and by monitoring announcements in the [Allegheny College Computer Science
...
Discord Server](https://discord.gg/juUXz7d4Jh) provides a way for members of
the security synapse community to use text and video to chat with each other
and will be the main forum for discussing the professional and technical
content in the field of computer security. The [Allegheny College Computer
...
student wants the instructor to assess (e.g., the work for a security survey
project or a checkpoint of the security summit project) must be in a GitHub
repository approved for use in this course.
...
that governs the entire academic program at Allegheny College. The Honor
...
work assigned for this class (e.g., programming skill checks, knowledge checks,
executable examinations, and course assignments). All students who have
...
Students who create the source code and documentation for their any course
project or assessment (e.g., programming skill checks, knowledge checks,
executable examinations, and security survey projects) should ensure the
implementation of a high-quality final product in the field of computer
security. While students are permitted to use a wide variety of computer
security tools, such as integrated development environments, testing
frameworks, automated input fuzzers, static analysis toolkits, and automated
code generators (e.g., systems that leverage large language models like GitHub
Copilot or OpenCode or Pi) and documentation sites such as StackOverflow, they
must take responsibility for all of the source code and documentation that they
submit for this course, including any artifacts that are automatically
generated by a software tool.

This policy means that every student must work as an ethical and professional
security engineer by documenting the sources for their work and verifying the
correctness, maintainability, and long-term reliability and security of all
source code and documentation that they submit. As such, a student who uses
software tools to create content is responsible for citing their sources and
demonstrating their understanding of it during the in-person assessments.
Moreover, all students in the class are responsible for all of the source code
and documentation submitted to the GitHub repository that hosts their course
projects, including any tool-generated software artifacts. This means that
every student should be able to answer questions, during an in-person
...
with the instructor and your fellow learners in a computer security adventure!
