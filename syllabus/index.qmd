...
student misses one week of class, their grade will be reduced by one letter
grade, with three late attendances counting for an absence. A student's weekly
class participation grade also will be reduced if they are observed, during
either class or laboratory sessions, undertaking non-course-related activities
like viewing email, social media, or reading or creating other content not
connected to the field of computer security.
...
computer security. In-person assessment invite students to demonstrate their
knowledge of computer security without the aid of any external sources,
including, but not limited to, software tools on any type of device.
