...
projects during the week. On the Tuesday class session the assigned students
...
Thursday class session the assigned students will demonstrate and explain, in at
least two programming languages, the source code in a GitHub repository that
practically connects to the high-level computer security concepts presented in
the prior class session. Students may use external sources, including artificial
...
survey project provided that they cite these sources and explain how they used
them to complete the various components of an algorithm engineering project.
...
implement, evaluate, and present their own project in the field of computer
...
series of presentations and reports. Students may use external sources,
including artificial intelligence coding assistants, during the completion of
this project provided that they cite these sources and explain how they used
them to complete the various components of their work.
...
the instructor to address extenuating circumstances, no work will be accepted
after the deadline.
