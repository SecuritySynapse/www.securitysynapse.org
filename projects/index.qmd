...
Ultimately, the `networkmonitor` should work in the following modes:
...
- [IP Header Format - GeeksforGeeks](https://www.geeksforgeeks.org/ip-header/)

- **TCP Header Structure**
  - [TCP Segment Structure -
  Wikipedia](https://en.wikipedia.org/wiki/Transmission_Control_Protocol#TCP_segment_structure)
  - [TCP Header Format - GeeksforGeeks](https://www.geeksforgeeks.org/tcp-header/)
