...
work in fields like fuzzing and cryptography. The security summit project offers
the scaffolding for learners to complete independent research and development in
the field of computer security. Each project explores a specific topic in
connection with content from either accessible online resources or one of these
online textbooks:
...
broadly follows these steps:
  ...
  trace. This includes:
      ...
      - The number of unique values stored in the variables accessed by the
      instructions.
...
all of the chapters in the following textbooks:
...
complete an independent research project in the field of computer security.
  - {{< iconify fa6-solid diagram-project size=18px >}} **Tasks for the Project Proposal**
    ...
    - Write a proposal abstract with both an overview and the expected contributions
  ...
  - {{< iconify fa6-solid diagram-project size=18px >}} **Tasks for the Final Report**
    ...
    - Document the design of the experiment that you conducted to evaluate the tool
    - Using tables of data and/or graphs, report on the experimental results
    - Document the technical challenges that you faced and how you overcame them
