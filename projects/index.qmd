...
through twelve of
[CCP](https://inventwithpython.com/cracking/) introduce a wide variety of
different cryptography algorithms an explain how they may be cracked. 

- {{< iconify fa6-solid code size=18px >}} **Task**: This project invites you to
implement a `cryptobenchmark` in the Python programming language that will
automatically perform a doubling experiment to measure the encryption and
decryption performance for the `Fernet` and `rFernet` ciphers.
