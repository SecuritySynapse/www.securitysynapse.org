...
certain type of JSON inputs, submit those inputs to a in-memory server, observe
...
Interested in working on this project? You can preview the
[{{< iconify fa6-brands github size=18px >}} server-fuzzing-starter](https://github.com/SecuritySynapse/server-fuzzing-starter)
