...
certain types of JSON inputs, submit those inputs to an in-memory
server, observe the output and behavior of the server, and record important
details and any crashes. As you complete the project, please be mindful that
it places certain restrictions on the types of JSON inputs your
`serverfuzzer` should generate!
