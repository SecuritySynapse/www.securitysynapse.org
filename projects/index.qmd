...
important should read, in addition to additional online resources, all of the
chapters in the following textbooks:
  - {{< iconify fa6-solid book-open >}} [Computer Systems
  Security: Planning for Success](https://web.njit.edu/~rt494/security/) 
  - {{< iconify fa6-solid book-open >}} [Cracking Codes
  with Python](https://inventwithpython.com/cracking/) 
  - {{< iconify fa6-solid book-open >}} [Operating
